...
| Неремонтопригодность                                                                                        | Невозможность отремонтировать изделие, заменить комплектующие без замены других деталей | <font color="#ffc000">Средняя</font> | Изделие должно легко разбираться и собираться без поломок других деталей. Доступ должен быть обеспечен ко всем элементам.              |
